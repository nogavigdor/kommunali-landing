<template>
    <nav class="flex justify-between bg-gray-100 py-4 px-6">
      ...
      <NuxtLink v-else to="/#hero" :class="{ active: currentSection === 'hero' }" class="nav-link">Home</NuxtLink>
      ...
      <NuxtLink v-else to="/#about" :class="{ active: currentSection === 'about' }" class="nav-link">About</NuxtLink>
      ...
      <NuxtLink v-else to="/#faq" :class="{ active: currentSection === 'faq' }" class="nav-link">FAQ</NuxtLink>
      ...
      <NuxtLink v-else to="/#signup" :class="{ active: currentSection === 'signup' }" class="nav-link">Sign Up</NuxtLink>
  
      <!-- Blog link -->
      <NuxtLink to="/blog" :class="{ active: isBlogPage }" class="nav-link">Blog</NuxtLink>
    </nav>
  </template>
